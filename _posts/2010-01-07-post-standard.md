...
1. Many more quantaties other than the energy and forces are obtained from these calculations, for example:
  1. Hirshfield Charges
  2. Charge density 
  3. Electronic States
2. Significantly more accuracy than emperical/classically based interatomic potentials
3. Able to describe reactive systems and perform bond breaking/making
